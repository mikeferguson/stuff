 ...
 * Too much rotation 90deg Right
 * Need to enter room further
...
void setup(){   
    ...
    while(wait){
        ...
        //delay(250);
        //Serial.print(getLeftIR());
        ///Serial.print(",");
        //Serial.print(getLeftSideIR());
        //Serial.print(",");
        //Serial.print(getRightIR());
        //Serial.print(",");
        //Serial.println(getRightSideIR());
        //float r = followWall();
        //Serial.print(travelRotZ);
        //Serial.print(",");
        //Serial.println(r);
    }
