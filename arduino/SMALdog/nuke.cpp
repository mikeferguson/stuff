...
//int mins[] = {334, 463, 1, 321, 194, 160, 474, 289, 376, 1, 164, 194};
int mins[] = {152, 461, 1, 336, 193, 160, 474, 231, 323, 1, 159, 192};
//int maxs[] = {559, 676, 652, 1023, 859, 822, 728, 548, 1023, 685, 823, 856};
...
void setupIK(){
  endpoints[RIGHT_FRONT].x = 25; //10;     // was 20
  endpoints[RIGHT_FRONT].y = 30;    // was 50
  endpoints[RIGHT_FRONT].z = 130;    // was 140

  endpoints[RIGHT_REAR].x = -0;
  endpoints[RIGHT_REAR].y = 30;
  endpoints[RIGHT_REAR].z = 130;

  endpoints[LEFT_FRONT].x = 25;
  endpoints[LEFT_FRONT].y = -30;
  endpoints[LEFT_FRONT].z = 130;

  endpoints[LEFT_REAR].x = -0;
  endpoints[LEFT_REAR].y = -30;    // works well at 30
  endpoints[LEFT_REAR].z = 130;
