...
int mins[] = {163, 296, 161, 296, 300, 163, 300, 162, 296, 157, 164, 301};
int maxs[] = {722, 857, 725, 859, 859, 731, 859, 725, 864, 724, 733, 858};
...
void setupIK(){
  endpoints[RIGHT_FRONT].x = 45; //40;
  endpoints[RIGHT_FRONT].y = 110;
  endpoints[RIGHT_FRONT].z = 120;

  endpoints[RIGHT_REAR].x = -45;
  endpoints[RIGHT_REAR].y = 110;
  endpoints[RIGHT_REAR].z = 120; 

  endpoints[LEFT_FRONT].x = 45;
  endpoints[LEFT_FRONT].y = -110;
  endpoints[LEFT_FRONT].z = 120; 

  endpoints[LEFT_REAR].x = -45;
  endpoints[LEFT_REAR].y = -110;
  endpoints[LEFT_REAR].z = 120;
