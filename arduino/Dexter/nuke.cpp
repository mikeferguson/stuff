...
int mins[] = {512, 205, 165, 358, 335, 220, 205, 512, 165, 358, 335, 220, 358, 358, 165, 358, 335, 220};
int maxs[] = {818, 512, 665, 850, 800, 689, 512, 818, 665, 850, 800, 689, 665, 665, 665, 850, 800, 689};
...
void setupIK(){
  endpoints[RIGHT_FRONT].x = 52;  // was 52
  ...
  endpoints[RIGHT_MIDDLE].y = 134;
  endpoints[RIGHT_MIDDLE].z = 90;

  endpoints[LEFT_MIDDLE].x = 0;
  endpoints[LEFT_MIDDLE].y = -134;
  endpoints[LEFT_MIDDLE].z = 90;
